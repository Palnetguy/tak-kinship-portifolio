...
export default function BentoCard({
  ...
  return (
    <div
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-border-subtle bg-[#0a0b0a] p-7 transition-colors duration-300 hover:border-[color-mix(in_srgb,var(--text-accent)_40%,transparent)]"
      style={{ minHeight }}
    >
