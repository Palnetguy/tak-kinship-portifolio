...
export default function Card({
  ...
  return (
    <div className="flex min-h-[311px] flex-col items-center justify-center gap-4 rounded-xl border border-border-subtle bg-surface px-8 py-10 text-center tak-hover-glow">
      {Icon && (
